...
public class InstanceResource {
    ...
    public Response statusUpdate(@QueryParam("value") String newStatus,
                                 @HeaderParam(PeerEurekaNode.HEADER_REPLICATION) String isReplication, @QueryParam("lastDirtyTimestamp") String lastDirtyTimestamp) {
        try {
    ...
    public Response deleteStatusUpdate(@HeaderParam(PeerEurekaNode.HEADER_REPLICATION) String isReplication, @QueryParam("value") String newStatusValue, @QueryParam("lastDirtyTimestamp") String lastDirtyTimestamp) {
        try {
            ...
            boolean isSuccess = registry.deleteStatusOverride(app.getName(), id, newStatus,
    ...
    /**
     * Updates user-specific metadata information. If the key is already available, its value
     * will be overwritten.
        ...
        if (appInfo != null) {
            if ((lastDirtyTimestamp != null) && (!lastDirtyTimestamp.equals(appInfo.getLastDirtyTimestamp()))) {
                ...
                if (lastDirtyTimestamp > appInfo.getLastDirtyTimestamp()) {
                    ...
                    // In the case of replication, send the current instance info in the registry
                    // for the
